...
ghcjsPrimIface
  ...
  where
    ...
    fixities = (getOccName seqId, Fixity NoSourceText 0 InfixR)  -- seq is infixr 0
...
#include "prim/primop-primop-info-802.hs-incl"
#elif __GLASGOW_HASKELL__ >= 711
...
#error "unsupported GHC version"
#elif __GLASGOW_HASKELL__ >= 801
#include "prim/primop-strictness-802.hs-incl"
#elif __GLASGOW_HASKELL__ >= 711
